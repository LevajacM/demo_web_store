...
// Source: ./sanity/lib/products/getSingleProductBySlug.ts
// Variable: SINGLE_PRODUCT_BY_SLUG_QUERY
// Query: *[_type == "product" && slug.current == $slug] | order(name asc)[0]
export type SINGLE_PRODUCT_BY_SLUG_QUERYResult = {
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
